...
file_path = "tra-pids.html"
with open(file_path, "r", encoding="utf-8") as f:
    content = f.read()

start_idx = content.find("        /* 🔥 RWD 修正區塊")
if start_idx == -1:
    start_idx = content.find("        @media (max-width: 699px)")
...
new_media = """        /* 🔥 手機版/直向螢幕 終極優化 (針對 iPhone/Android 螢幕) */
...
new_content = content[:start_idx] + new_media + "    </style>" + content[end_idx + 8:]
